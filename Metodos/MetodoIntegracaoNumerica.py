...
class MetodoIntegracaoNumerica:
    ...
    def Ajuda(self):
        texto_ajuda = 'Para inserir a equação utilize os seguintes operadores     \n'\
                      ...
                      '  - \'-\' : Subtração                                      \n' \
                      '  - \'/\' : Divisão                                        \n' \
                      '  - np.pi : valor de pi utilizando a biblioteca numpy      \n' \
                      '  - é possivel utilizar as funções sin(), cos() entre outras\n' \
    ...
    def ExemploInteressante(self):
        textoExemplo = '  Um exemplo interessante é a função sin(x), com o     \n' \
                       'intervalo indo de 0 até np.pi/2 (utiliza o pi do numpy)\n' \
                       'utilizando 100 pontos.'
